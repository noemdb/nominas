            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    <x-wireui-toggle
                        ...
                        description="Activar para indicar que el descuento será expresado en moneda de referencia [USD]"
                    />
                </div>
                ...
                <div class="sm:col-span-2">
                    <x-wireui-toggle
                        ...
                        label="Activo"
                        description="Activar para que el descuento esté disponible para su uso en nóminas."
                    />
                </div>
