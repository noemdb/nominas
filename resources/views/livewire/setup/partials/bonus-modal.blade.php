<!-- Modal para crear/editar bonificación -->
<x-modal
    :title="$editing ? 'Editar Bonificación' : 'Crear Bonificación'"
    :max-width="'2xl'"
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    <x-wireui-toggle
                        ...
                        description="Activar para indicar que la bonificación será expresada en moneda de referencia [USD]"
                    />
                </div>
