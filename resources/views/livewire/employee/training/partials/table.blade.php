@php
    ...
    $class['provider']='hidden lg:table-cell';
    $class['location']='hidden lg:table-cell';
    $class['duration_hours']='hidden lg:table-cell';
    $class['action']='';
    /* 'employee_name','name','description','provider','location','duration_hours' */
@endphp
...
<div class="grid grid-cols-1 sm:grid-cols-4 gap-4">
    <div class="col-span-1 sm:col-span-3">
        ...
        @php $label = "Nombre del empleado, ci, nombre, descripción, proveedor" @endphp
    ...
    <table class="table-auto w-full text-left whitespace-no-wrap my-2">
        <thead>
            ...
            <tr class="bg-gray-200 text-sm">
                ...
                @php $name = 'duration_hours' @endphp
                <th class="px-2 py-1 {{$class[$name] ?? null}}">
                    <div class="flex justify-between">
                        <div>{{$list_comment[$name] ?? ''}}</div>
                        @if($trainings->isNotEmpty())
