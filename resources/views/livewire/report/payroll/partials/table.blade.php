<div class="overflow-x-auto soft-scrollbar">
    ...
    <tbody class="bg-white divide-y divide-gray-200">
      <tr>
        <td class="px-6 py-4 whitespace-nowrap text-sm fonto-medium text-gray-900">Juan Pérez</td>
      ...
      <tr>
        ...
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">$3,000.00</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">$450.00</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">$2,550.00</td>
        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
          <a href="#" class="text-indigo-600 hover:text-indigo-900">Editar</a>
        </td>
      </tr>
