<div class="overflow-x-auto soft-scrollbar">
    ...
    <thead>
      <tr class="bg-gray-50">
        ...
        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tipo de prestación social</th>
    ...
    <tbody class="bg-white divide-y divide-gray-200">
      <tr>
        ...
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Seguro de salud</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">$500</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">01/06/2022</td>
      ...
      <tr>
        ...
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Bono de productividad</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">$200</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">15/07/2022</td>
        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
          <a href="#" class="text-indigo-600 hover:text-indigo-900">Editar</a>
           </tr>
