<div class="overflow-x-auto soft-scrollbar">
    ...
    <thead>
      <tr class="bg-gray-50">
        ...
        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tipo de ausencia o permiso</th>
    ...
    <tbody class="bg-white divide-y divide-gray-200">
      <tr>
        ...
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Licencia médica</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">10/05/2022</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">15/05/2022</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">6 días</td>
      ...
      <tr>
        ...
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Permiso por paternidad</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">01/07/2022</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">10/07/2022</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">10 días</td>
        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
          <a href="#" class="text-indigo-600 hover:text-indigo-900">Editar</a>
        </td>
      </tr>
