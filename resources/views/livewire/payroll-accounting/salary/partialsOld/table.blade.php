<div class="overflow-x-auto soft-scrollbar">
    ...
    <tbody class="bg-white divide-y divide-gray-200">
        <tr>
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Gerente de ventas</td>
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">5,000.00</td>
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">01/01/2022</td>
        ...
        <tr>
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Analista de sistemas</td>
