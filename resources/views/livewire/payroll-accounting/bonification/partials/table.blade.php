<div class="overflow-x-scroll">
    ...
    <tbody class="bg-white divide-y divide-gray-200">
        <tr>
            ...
            <td class="px-6py-4 whitespace-nowrap text-sm text-gray-500">$500.00</td>
        ...
        <tr>
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2022-05-15</td>
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">$700.00</td>
            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <a href="#" class="text-indigo-600 hover:text-indigo-900">Editar</a>
            </td>
        </tr>
