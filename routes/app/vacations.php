...
use App\Http\Controllers\Vacation\Approved\IndexController as VacationApprovedIndexController;
...
Route::get('/vacations/approveds', [VacationApprovedIndexController::class, 'index'])->name('vacations.approveds');
