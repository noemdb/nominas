...
use App\Http\Controllers\Formulation\Report\IndexController as FormulationReportsIndexController;
...
Route::get('/formulations/reports', [FormulationReportsIndexController::class, 'index'])->name('formulations.reports');
